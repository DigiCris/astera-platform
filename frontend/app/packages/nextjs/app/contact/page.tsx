      ...
      <main className="flex-1 bg-filabe-dark">
        <div className="container py-12 px-4 md:px-6">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-3xl font-bold mb-6 text-filabe-text">Contacto</h1>

            <div className="grid gap-8 md:grid-cols-2">
              {/* Formulario de Contacto */}
              <Card className="bg-filabe-gray border-filabe-lightgray">
                <CardHeader>
                  <CardTitle className="text-filabe-text">Envíanos un mensaje</CardTitle>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="phone" className="text-filabe-text">
                      Teléfono (opcional)
                    </Label>
                    <Input
                      id="phone"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="subject" className="text-filabe-text">
                      Asunto
                    </Label>
                    <Select>
                      <SelectTrigger id="subject" className="bg-filabe-dark border-filabe-lightgray text-filabe-text">
                        <SelectValue placeholder="Selecciona un asunto" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="general">Consulta general</SelectItem>
                        <SelectItem value="investment">Información sobre inversiones</SelectItem>
                        <SelectItem value="project">Información sobre proyectos</SelectItem>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="message" className="text-filabe-text">
                      Mensaje
                    </Label>
                    <Textarea
                      id="message"
                      placeholder="Escribe tu mensaje aquí..."
                      className="min-h-[150px] bg-filabe-dark border-filabe-lightgray text-filabe-text"
                    />
                  </div>
                </CardContent>
                <CardFooter>
              ...
              <div className="space-y-6">
                <Card className="bg-filabe-gray border-filabe-lightgray">
                  <CardHeader>
                    <CardTitle className="text-filabe-text">Información de Contacto</CardTitle>
                    <CardDescription className="text-filabe-text/70">
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-filabe-text">Email</p>
                        <p className="text-filabe-text/70">info@filabe.com</p>
                        <p className="text-filabe-text/70">soporte@filabe.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-filabe-text">Teléfono</p>
                        <p className="text-filabe-text/70">+54 11 1234-5678</p>
                        <p className="text-filabe-text/70">Lunes a Viernes, 9:00 - 18:00</p>
                      </div>
                    </div>

                    <div className="flex items-start gap-4">
                      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-filabe-teal/20 shrink-0 mt-0.5">
                        <MapPin className="h-5 w-5 text-filabe-teal" />
                      </div>
                      <div>
                        <p className="font-medium text-filabe-text">Oficina Central</p>
                        <p className="text-filabe-text/70">Av. Corrientes 1234, Piso 5</p>
                        <p className="text-filabe-text/70">Ciudad Autónoma de Buenos Aires</p>
                        <p className="text-filabe-text/70">Argentina, C1043AAZ</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-filabe-gray border-filabe-lightgray">
                  <CardHeader>
                    <CardTitle className="text-filabe-text">Horario de Atención</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <div className="flex justify-between">
                      <span className="text-filabe-text/70">Lunes a Viernes</span>
                      <span className="text-filabe-text">9:00 - 18:00</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-filabe-text/70">Sábados</span>
                      <span className="text-filabe-text">10:00 - 14:00</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-filabe-text/70">Domingos y Feriados</span>
                      <span className="text-filabe-text">Cerrado</span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-filabe-gray border-filabe-lightgray">
                  <CardHeader>
                    <CardTitle className="text-filabe-text">Redes Sociales</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="flex gap-4 justify-center">
                      <Button
                        variant="outline"
                        size="icon"
                        className="rounded-full border-filabe-lightgray text-filabe-text hover:bg-filabe-dark hover:text-filabe-teal"
                      >
                        <svg
      ...
      <footer className="bg-filabe-dark border-t border-filabe-lightgray py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/contact" className="text-sm text-filabe-teal hover:underline">
              Contacto
            </Link>
          </div>
        </div>
